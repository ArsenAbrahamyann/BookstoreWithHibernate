...
public class CustomerManagement {
    ...
    public static void insertCustomer() {
        ...
        String phone = "" + ValidationManagement.getPhoneInput("Invalid phone format. " +
    ...
    /**
     * Prints details of all customers in the database.
     */
    ...
    /**
     * Prints the purchase history of a customer based on their ID.
     */
